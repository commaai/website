...
// An entry with a clip renders as video; a nested list renders as a thread.
// Videos live in static/videos/tweets — duration is the full clip on X, not the
// ten second cut we loop.
...
export const tweets = [
  ...
  [
    ...
    {
      // leading @handles left off, the way X hides them on a reply
