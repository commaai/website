...
<script>
  ...
  import { currentProductPrice } from "../../../store.js";
  ...
  // Browser only — a module-level store written during SSR leaks between requests
  $: if (browser) currentProductPrice.set(priceDueToday);
