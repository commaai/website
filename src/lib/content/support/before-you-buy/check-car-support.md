...
3. Find the model and model-year range that includes your car.
4. Open the listing and read the **Support** card and every **Note**. These identify any required factory package, trim, or hardware and describe limitations specific to that car.

![Car manufacturers on the supported cars page](/images/support/compatibility-search.png)

Match the model year, not the year you bought or registered the car. You can find the model year in the vehicle information shown on your registration, insurance documents, or the label inside the driver's door.
...
![Selecting a Toyota Corolla in the comma four car picker](/images/support/comma-four-car-search.png)
...
If you have automotive programming experience, you can also read the [openpilot car porting guide](https://github.com/commaai/openpilot/blob/master/docs/CARS.md#dont-see-your-car-here) to learn about adding support for a car.
