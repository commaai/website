  ...
  <div class="container">
    <Grid templateColumns="0.5fr 1.25fr">
      ...
      <div class="fine-print-copy">
          ...
          <p>
            Save offer within PayPal account prior to purchase. Expires 12/8/25. 20% on up to max $1,250 spend per transaction (max 25K points or $250). 1.5B points available in total for this promo. See paypal.com/promoterms. Points can be redeemed for cash and more. Terms and exclusions apply. See paypal.com/rewardsterms.
          </p>
          <p>
